...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'setup/static') #caminho da pasta do css
]

STATIC_ROOT = os.path.join(BASE_DIR, 'static')  #caminho da pasta do css

MEDIA_ROOT =  os.path.join(BASE_DIR, 'media') #gravar imagens
